...
export function siteKey(ns: SiteNamespace, locSlug: string, bizSlug: string): string {
  return ns === 'draft'
...
export async function getSite(
  r2: R2Bucket, ns: SiteNamespace, locSlug: string, bizSlug: string,
...
export async function putSite(
  r2: R2Bucket, ns: SiteNamespace, locSlug: string, bizSlug: string, data: SiteData,
): Promise<void> {
...
export async function promoteDraft(
  r2: R2Bucket, locSlug: string, bizSlug: string,
): Promise<boolean> {

...
export async function generateContent(llm: LLMProvider, biz: BusinessInput): Promise<SiteContent> {
...
export async function editContent(
  llm: LLMProvider, current: SiteContent, instruction: string,
): Promise<SiteContent> {
  const raw = await llm.complete([
...
export function summarizeChanges(old: SiteContent, updated: SiteContent): string {
